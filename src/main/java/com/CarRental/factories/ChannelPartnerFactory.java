...
public class ChannelPartnerFactory {
    ...
    public static ChannelPartner buildChannelPartner(Integer channelPartnerId, String channelPartnerName, String channelPartnerContact, String channelPartnerEmail)
    {
